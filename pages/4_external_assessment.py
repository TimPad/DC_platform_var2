...
<a href="https://pmo.hse.ru/servicedesk/customer/portal/81/create/1274" target="_blank" class="instr-link">Заявка на загрузку оценок</a><br/>
<span style="color:var(--apple-accent)">💡 Рекомендация:</span> в описании указать <em>«Просьба передать на EDUSD Голубеву А.А.»</em>.
</div>
</div>
</div>
'''
