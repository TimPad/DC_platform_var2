...
**Файл с оценками** - таблица из внешней системы с тестированиями
**Список студентов** - загружается автоматически из Supabase (таблица students)
...
    count_res = supabase.table(table).select('count(*)', count='exact')
    if filters:
