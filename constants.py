...
COVER_LOGO_DC_GREEN_SVG = '''<svg width="348" height="229" viewBox="0 0 348 229" xmlns="http://www.w3.org/2000/svg">
  <path d="M237.001 135.495V100.331L347.26 41.7236V76.888L271.105 116.894V118.932L347.26 158.938V194.103L237.001 135.495Z" fill="#DFFF00"/>
  <path d="M0 228.824L82.3092 0H116.412L34.1032 228.824H0Z" fill="#DFFF00"/>
  <path d="M88.9137 158.498L180.82 118.932V116.894L88.9137 76.4479V41.2835L214.923 100.331V135.495L88.9137 193.663V158.498Z" fill="#DFFF00"/>
</svg>'''

COVER_LOGO_YANDEX_SVG = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 367 106">
  <path d="M349.9,92.3c7.2,0,12.3-1.3,16.1-4.1V75.5c-3.9,2.7-8.6,4.4-15.2,4.4c-11.1,0-15.7-8.6-15.7-22.2 c0-14.3,5.6-21.6,15.8-21.6c6,0,11.9,2.1,15,4.1V27c-3.3-1.8-9-3.1-16.8-3.1c-19.9,0-30.2,14.3-30.2,34.3 C319,80.1,329.1,92.3,349.9,92.3z M252.6,86.5V73.8c-4.8,3.3-13,6.2-20.5,6.2c-11.4,0-15.7-5.4-16.4-16.4h37.6v-8.2 c0-22.9-10.1-31.5-25.6-31.5c-19,0-28,14.5-28,34.4c0,22.9,11.3,34,31.1,34C240.7,92.3,248,89.6,252.6,86.5z M109.9,25.1v26H89.1 v-26H73.5V91h15.6V63.5h20.8V91h15.6V25.1H109.9z M195.8,78.6h-6.9V25.1h-45.4v5.6c0,16.1-1,36.9-6.5,47.9h-5V106h14.4V91h34.9v15 h14.4V78.6H195.8z M302.3,91H320l-25-35.5l22-30.4h-15.7l-22,30.4V25.1h-15.6V91h15.6V58.6L302.3,91z M227.3,36.1 c7.7,0,10.1,6.4,10.1,14.7v1.3h-21.7C216.1,41.6,219.9,36.1,227.3,36.1z M173.3,78.6h-22c4.3-9.9,5.5-27.9,5.5-39.3v-2h16.5V78.6z" fill="#000000"/>
  <path d="M60.5,91H44.6V12.3h-7.1c-13,0-19.8,6.5-19.8,16.2c0,11,4.7,16.1,14.4,22.6l8,5.4L17.1,91H0 l20.7-30.8C8.8,51.7,2.1,43.4,2.1,29.4C2.1,11.9,14.3,0,37.4,0h23L60.5,91L60.5,91z" fill="#FC3F1D"/>
</svg>'''
...
COVER_LOGOS = {
    ...
    "dc":     {"name": "Data Culture", "svg": COVER_LOGO_DC_SVG,     "svg_dark": COVER_LOGO_DC_GREEN_SVG,        "height": 32},
