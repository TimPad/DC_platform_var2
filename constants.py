...
COVER_LOGO_YANDEX_SVG = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 367 106">
  <g fill="#FFFFFF" stroke="#FFFFFF" stroke-width="8" stroke-linejoin="round">
    ...
    <path d="M60.5,91H44.6V12.3h-7.1c-13,0-19.8,6.5-19.8,16.2c0,11,4.7,16.1,14.4,22.6l8,5.4L17.1,91H0 l20.7-30.8C8.8,51.7,2.1,43.4,2.1,29.4C2.1,11.9,14.3,0,37.4,0h23L60.5,91L60.5,91z"/>
  </g>
  <g>
